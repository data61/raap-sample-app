(function() {
	...
	view: function(v) {
		...
		var permitted = escalator.operation.find(x => x.goal.modality == PERMITTED && x.reasoningResult == CONCLUSIVE);
		var obligatedNotTo = escalator.operation.find(x => x.goal.modality == OBLIGATED && x.goal.negated && x.reasoningResult == CONCLUSIVE);
	    }
